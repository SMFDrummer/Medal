...
/**
 * Android 账号存档, 包含一个默认存档, 需要时可自定义
 *
 * @property m pr 解密后 Json 数据 MD5 校验
 * @property pr Gzip 加密的 Json 存档数据
 * @property s Base64 加密的 Json 存档数据
 */
@PacketIdentifier("V206")
class V206(override val user: User) : Packet() {
    override val identifier: String = "V206"

    var m: String = "c9516215dd37a0c3800acd1953a2ab33" // pr 解密后 Json 数据 MD5 校验
    ...
    var s: String =
        "eyJzZHMiOnsiZCI6MjcsImciOjUsImMiOjUwMDAwMDAwMCwiZXMiOjE3LCJjcyI6MCwicHMiOjEwLCJrcyI6MCwiZnMiOjAsImRzIjowLCJsIjoicGlyYXRlMTAiLCJ1cHMiOjEwLCJ1YXMiOjAsInBsIjoxMH19"
