...
import smf.talkweb.medal.ui.theme.components.topbar.TopBarDefaults.TopBarHeight
...
fun TopBarSamples() {
    ...
    Column(
        ...
        Text("Sample 1: Title Centered", style = MedalTheme.typography.label1)
        ...
        TopBar(
            ...
            Box(
                ...
                Text(
                    text = "Title", style = MedalTheme.typography.h3, color = Color.White
                )
            }
        }
        Spacer(modifier = Modifier.height(32.dp))

        Text("Sample 2: Logo Left, Title Center, Logo Right", style = MedalTheme.typography.label1)
        Spacer(modifier = Modifier.width(16.dp))
        ...
        Text("Sample 3: Logo and Title Left", style = MedalTheme.typography.label1)
        TopBar(
            colors = TopBarDefaults.topBarColors().copy(containerColor = Color.Black)
        ) {
            Row(
