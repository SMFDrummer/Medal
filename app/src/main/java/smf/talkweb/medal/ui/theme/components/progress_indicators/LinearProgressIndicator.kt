package smf.talkweb.medal.ui.theme.components.progress_indicators
...
fun LinearProgressIndicatorPreview() {
    MedalTheme {
        Column(
            ...
            Text(text = "Determinate Progress", style = MedalTheme.typography.body1)
            LinearProgressIndicator(progress = 0.7f)

            Text(text = "Indeterminate Progress", style = MedalTheme.typography.body1)
